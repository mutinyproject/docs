...
* Software
    ...
    ** Toolchain
        *** LLVM is currently being reconsidered in favor of the usual GNU toolchain.
            ...
            creating their own libc written in C++ for whatever reason]. A project with goals like
            this carrying a lot of baggage I'm really not interested in involving with my project.
